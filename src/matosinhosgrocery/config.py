...
from pydantic import field_validator, AnyHttpUrl, PostgresDsn, RedisDsn, Field, model_validator, computed_field
...
class Settings(BaseSettings):
    ...
    ENV_TELEGRAM_ALLOWED_USER_IDS: Optional[str] = Field(default=None, validation_alias="TELEGRAM_ALLOWED_USER_IDS")
    ...
    GOOGLE_DRIVE_CREDENTIALS_PATH: Optional[str] = None # Path to the JSON credentials file
    GOOGLE_DRIVE_FOLDER_ID: Optional[str] = None      # Optional: Specific folder ID to store receipts
